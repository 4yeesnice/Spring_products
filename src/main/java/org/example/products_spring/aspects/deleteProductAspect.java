...
@Component
@Aspect
public class deleteProductAspect {
        Logger logger = Logger.getLogger(deleteProductAspect.class.getName());
        Connection connection = null;

        @Around("@annotation(org.example.products_spring.aspects.annotation.toCheckProduct)")
        public void deleteProduct(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        for (Object arg : args) {
            if (arg instanceof Integer) {
                try{
                    ...
                    String sqlQuery = "delete from orders_products where product_id = ?";
